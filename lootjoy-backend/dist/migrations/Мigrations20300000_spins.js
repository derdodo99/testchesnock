...
exports.MigrationXXXXXXXXXXXXXX = void 0;
const migrations_1 = require("@mikro-orm/migrations");
class MigrationXXXXXXXXXXXXXX extends migrations_1.Migration {
    async up() {
        this.addSql(`
    ...
    `);
        ...
        this.addSql(`create index if not exists "spin_rolls_created_at_idx" on "spin_rolls" ("created_at");`);
        this.addSql(`
...
exports.MigrationXXXXXXXXXXXXXX = MigrationXXXXXXXXXXXXXX;
//# sourceMappingURL=%D0%9Cigrations20300000_spins.js.map