...
exports.Migration20251004CreateRpsTables = void 0;
const migrations_1 = require("@mikro-orm/migrations");
class Migration20251004CreateRpsTables extends migrations_1.Migration {
    async up() {
        this.addSql(`
    ...
    `);
        ...
        this.addSql(`CREATE INDEX IF NOT EXISTS "rps_games_created_at_idx" ON "rps_games" ("created_at");`);
        this.addSql(`
    ...
    `);
        this.addSql(`CREATE UNIQUE INDEX IF NOT EXISTS "rps_moves_game_user_uq" ON "rps_moves" ("game_id","user_id");`);
    }
    async down() {
...
exports.Migration20251004CreateRpsTables = Migration20251004CreateRpsTables;
//# sourceMappingURL=%D0%9Cigrations20300001_games.js.map